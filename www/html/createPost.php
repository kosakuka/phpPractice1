...
if( empty($bookName) || empty($bookAuthor) ){
    header('Location: blank.html?label=errorCreate');//情報登録ページに遷移
    ...
    header('Location: blank.html?label=successUpdate');//検索結果が表示されているページに遷移
    ...
    header('Location: blank.html?label=successCreate');//検索結果が表示されているページに遷移
}
